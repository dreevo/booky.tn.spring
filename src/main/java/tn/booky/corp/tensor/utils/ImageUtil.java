package tn.booky.corp.tensor.utils;

import tn.booky.corp.tensor.services.*;
...
public class ImageUtil {
    ...
    private ImageUtil(final TensorProperties applicationProperties) {
     ...
     */
    public static ImageUtil getInstance(final TensorProperties applicationProperties) {
        if (imageUtil == null) {
